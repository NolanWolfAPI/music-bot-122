# CONFIG
# ---------
token = "NTM4OTcwNzI3MDg1NTA2NTYx.Dy7jLA.I539Whw7cz6Wkx1WgSnrHAKZjG0" # To find this, press CTRL + SHIFT + i in the Discord client revealing the inspect element prompt. Click the arrows, head over to Application, local storage and there you can find your user token :)
prefix = "~" # This will be used at the start of commands.
rename_to = "DESTROYED" # The string everyone possible will be renamed to using the 'rall' command.
# ----------
